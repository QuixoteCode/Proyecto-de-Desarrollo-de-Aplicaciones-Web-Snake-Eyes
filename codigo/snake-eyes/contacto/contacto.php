<?php
    ...
    //Si se ha enviado procesamos el formulario y recibimos sus datos
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $statement = $conexion->prepare("INSERT INTO contactos (nombre, email, mensaje) VALUES (?, ?, ?)");
        $statement->bind_param("sss", $nombre, $email, $mensaje);
    
        //La ejecutamos
        if ($statement->execute()) {
            echo "<p class='m-3 p-3'>Mensaje enviado con éxito.</p>";
        } else {
            echo "<p class='m-3 p-3'>Error: " . $statement->error . "</p>";
        }
...
<body class="bg-dark text-white">
    ...
    <section id="contenido">
        ...
        <p class="h1 m-2 p-2">Contacto</p>

        <p class="h4 m-2 p-2">Escribe tu mensaje debajo cumplimentando el siguiente formulario para ponerte en contacto con nosotros.</p>
        <br>
        ...
        <section class="col-12 col-sm-6">
            ...
            <form action="" method="POST" class="m-2 p-2">
                <section class="m-2 p-2">
                    ...
                    <textarea id="mensaje" name="mensaje" class="form-control" rows="3" required></textarea><br><br>
                
                    <input type="submit" value="Enviar" class="btn btn-danger btn-lg ml-4">
                </section>
        </form>
        </section>
    </section>
