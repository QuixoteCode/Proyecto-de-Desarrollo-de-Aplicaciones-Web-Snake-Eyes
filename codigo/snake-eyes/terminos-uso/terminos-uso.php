...
<head>
    ...
    <link rel="stylesheet" href="terminos-uso.css">
</head>
<body class="bg-secondary">
    ...
    <section id="contenido">
        <section class="bg-dark p-3">
            <p class="text-center text-white h1">Términos de uso</p><br>
            <section class="text-white h2">
                <p>Usted se compromete a no hacer un uso malicioso de nuestro servicio web, de lo contrario se le puede
                    negar la continuación de la permanencia en este.</p>
                <p>Un uso indebido incluye pero no se limita a:</p>
                <ul>
                    <li>La discusión o la subida de contenido inadecuado como puede ser los temas de índole para mayores de 18.</li>
                    <li>La promoción reiterada de otros servicios.</li>
                    <li>La creación de múltiples posts idénticos con el objetivo de molestar o de publicitar otro servicio.</li>
                    <li>El acoso a usuarios o terceros y la subida de información personal sin su permiso.</li>
                    <li>La subida reiterada de contenido "off-topic", es decir, contenido que se sale del tema de discusión
                        de los juegos de mesa y demás.</li>
                </ul>
            </section>
        </section>
    </section>
    ...
    <script src="terminos-uso.js"></script>
</body>
</html>