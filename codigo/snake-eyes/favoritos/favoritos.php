...
<body class="bg-dark text-light">
    ...
    <section id="contenido">
        <section class="p-4">
            <?php
                if (!isset($_SESSION['user_id'])) {
                    echo "<p>Por favor, <a href='../dashboard/dashboard.php'>inicia sesión</a> para ver tus productos favoritos.</p>";
                }else{
                    ...
                    //Comprobamos que la conexión se ha producido con éxito
                    ...
                    //Obtenemos los productos que el usuario ha añadido a favoritos
                    ...
                    //Comprobamos que el usuario tiene productos añadidos a favoritos
                    if ($resultado->num_rows > 0) {
                        ...
                        while ($fila = $resultado->fetch_assoc()) {
                            echo "<tr>
                                ...
                                <td><button class='btn btn-danger' onclick='anadirCarrito(" . $fila['id'] . ")'>Añadir al carrito</button></td>
                                <td>
                                    <form action='eliminar-favorito.php' method='post' class='formulario-eliminar-favoritos'>
                                        <input type='hidden' name='producto_id' value='" . htmlspecialchars($fila['id']) . "'>
                                        <button type='submit' title='Eliminar de favoritos'>
                                            <svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' fill='red' class='bi bi-heart' viewBox='0 0 16 16'>
                                                ...
                                                <line x1='0' y1='0' x2='13' y2='13' style='stroke:red;stroke-width:2' />
                                            </svg>
                                        </button>
                                    </form>
                                </td>
                        ...
                        echo "<p>No has añadido ningún producto a tus favoritos.</p>";
                    }
